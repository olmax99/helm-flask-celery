...
# from flaskapi.core.postgres_conn import db_session
...
redis_conn = FlaskRedis.from_custom_provider(DecodedRedis, app=None, config_prefix='REDIS')
...
def init_app(app_obj):
    ...
    # from flaskapi.core.postgres_conn import init_db
    # db.init_app(app)
